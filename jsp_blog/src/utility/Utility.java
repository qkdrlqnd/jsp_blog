...
public class Utility {
	...
	public static String paging3(int totalRecord, int nowPage, int recordPerPage, String col, String word) {
	    ...
	    int nowGrp 		= (int)(Math.ceil((double)nowPage/pagePerBlock));    // 현재 그룹 1-10(1그룹),11-20(2그룹),.....
	    int startPage	= ((nowGrp - 1) * pagePerBlock) + 1; // 특정 그룹의 페이지 목록 시작  
	    int endPage 	= (nowGrp * pagePerBlock);             // 특정 그룹의 페이지 목록 종료   
    ...
    public static String paging100(int totalRecord, int nowPage, int recordPerPage) {
		...
		int _nowPage = (nowGrp - 1) * pagePerBlock; // 10개 이전 페이지로 이동
		if (nowGrp >= 2) {
			str.append("<li><a class=\"w3-hover-black\" href='./bottomtest.jsp?nowPage=" + _nowPage + "'>이전</a></li>");
		}
		...
		for (int i = startPage; i <= endPage; i++) {
			...
			if (nowPage == i) {
//				str.append("<li><a class=\"w3-hover-black\" href='./index.jsp?nowPage=" + i + "'>" + i + "</a></li>");
				str.append("<li><a class=\"w3-hover-black\" href='./bottomtest.jsp?nowPage=" + i + "'>" + i + "</a></li>");
			} else {
				str.append("<li><a class=\"w3-hover-black\" href='./bottomtest.jsp?nowPage=" + i + "'>" + i + "</a></li>");
			}
		}
		...
		_nowPage = (nowGrp * pagePerBlock) + 1; // 10개 다음 페이지로 이동
		if (nowGrp < totalGrp) {
			str.append("<li><a class=\"w3-hover-black\" href='./bottomtest.jsp?nowPage=" + _nowPage + "'>다음</A></li>");
		}
		str.append("</DIV>");
